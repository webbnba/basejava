...
public class TestData {
    ...
    static {
        ...
        R1.setSection(SectionType.ACHIEVEMENT, new ListSection(List.of("Achivment11", "Achivment12", "Achivment13")));
        R1.setSection(SectionType.QUALIFICATIONS, new ListSection(List.of("Java", "SQL", "JavaScript")));
